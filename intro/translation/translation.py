...
opus=opus["train"].train_test_split(test_size=0.2)
#print(opus["train"][0])
...
2. set the target language(french).

3. truncate sequences to be no longer than the max_length
'''
...
def preprocess_function(examples):
    ...
    return model_inputs
tokenized_opus=opus.map(preprocess_function,batched=True)
